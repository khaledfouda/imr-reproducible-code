...
# Models: SImpute and IMR
#============================================================
# we begin by loading the results from scenario 2 - part 1. We use them to get the optimal
# hyperparameter values for both SImpute and IMR
...
# collect the rank and lambda for IMR
...
# collect the rank and lambda for soft-impute
results_scenario2_part_1 %>%
  filter(model == "SI") %>%
